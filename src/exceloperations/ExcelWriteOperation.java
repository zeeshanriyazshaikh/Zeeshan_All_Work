...
public class ExcelWriteOperation {
	...
	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
		      //COPY ALL FROM PARAMETERIZED TEST,AND PERFROM WRITE OPERATIONS
		//web driver code
			...
			reader.addColumn("RegTestData", "status"); //adding column
				...
				for(int rownum=2;rownum<=rowcount;rownum++)
				{
					...
					//	Thread.sleep(2000);
						...
						reader.setCellData("RegTestData", "status", rownum, "pass"); //write data in cell,always close excel tab while writing while reading its ok
	}
